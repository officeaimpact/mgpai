...
Последняя синхронизация: 2026-01-15 12:28:50
Количество стран: 74
...
LAST_SYNC = "2026-01-15T12:28:50.791583"
...
DEPARTURES: dict[str, int] = {
    # ID=1: Москва (все варианты)
    "москва": 1,
    "мск": 1,
    "moscow": 1,
    # ID=2: Пермь
    "пермь": 2,
    # ID=3: Екатеринбург (все варианты)
    "екатеринбург": 3,
    "екб": 3,
    "екат": 3,
    # ID=4: Уфа
    "уфа": 4,
    # ID=5: Санкт-Петербург (ВСЕ ВАРИАНТЫ - P3 FIX!)
    "санкт-петербург": 5,
    "санкт петербург": 5,
    "с.петербург": 5,
    "с петербург": 5,
    ...
    # ID=7: Самара
    "самара": 7,
    # ID=8: Нижний Новгород (все варианты)
    "нижний новгород": 8,
    "н.новгород": 8,
    "н новгород": 8,
    "нижний": 8,
    # ID=9: Новосибирск (все варианты)
    "новосибирск": 9,
    "новосиб": 9,
    "нск": 9,
    # ID=10: Казань
    ...
    # ID=17: Калининград
    "калининград": 17,
    # ID=18: Ростов-на-Дону (все варианты)
    "ростов-на-дону": 18,
    "ростов на дону": 18,
    "ростов": 18,
    "рнд": 18,
    ...
    # ID=23: Владивосток
    "владивосток": 23,
    # ID=24: Южно-Сахалинск (все варианты)
    "южно-сахалинск": 24,
    "южно сахалинск": 24,
    "ю.сахалинск": 24,
    "южносахалинск": 24,
    ...
    # ID=38: Брянск
    "брянск": 38,
    # ID=39: Минеральные Воды (все варианты)
    "минеральные воды": 39,
    "мин.воды": 39,
    "мин воды": 39,
    "минводы": 39,
    ...
    # ID=42: Улан-Удэ
    "улан-удэ": 42,
    # ID=43: Петропавловск-Камчатский (все варианты)
    ...
    # ID=56: Сочи
    "сочи": 56,
    # ID=61: Набережные Челны (все варианты)
    "набережные челны": 61,
    "наб.челны": 61,
    "наб челны": 61,
    "челны": 61,
